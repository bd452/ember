...
```toml
[dependencies]
ember = { path = "../ember" }          # host / tests
# ember = { path = "../ember", features = ["fbink"] }  # on device
```
...
See [`ember-demo`](../../ember-demo/src/main.rs): counter, `for_each`
